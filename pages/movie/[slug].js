...
//       <Head>
//         <title>{movie.title} ({movie.releaseYear}) - Watch Online Free</title>
//         <meta name="description" content={movie.description} />
//         <meta property="og:title" content={`${movie.title} (${movie.releaseYear})`} />
...
//     "@type": "Article",
//     "headline": `${movie.title} (${movie.releaseYear}) - Complete Review & Watch Online`,
...
//               <button
//                 onClick={() => shareOnFacebook(currentUrl, shareTitle)}
...
//               <button
//                 onClick={() => shareOnTwitter(currentUrl, shareTitle)}
...
//               <button
//                 onClick={() => shareOnLinkedIn(currentUrl, shareTitle, shareDescription)}
...
export default function MoviePage() {
  ...
  const getAbsoluteThumbnailUrl = (thumbnail) => {
    ...
    // If thumbnail already has http, return as is
    if (thumbnail.startsWith('http')) {
      return thumbnail;
    }
    
    // If thumbnail starts with /, append to SITE_URL
